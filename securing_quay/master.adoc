...
* Inheriting the {ocp} cluster TLS security profile for {productname-ocp}
* Referencing an external TLS Secret for automated certificate rotation on {productname-ocp}
* Enabling TLS encryption for Operator-managed PostgreSQL on {productname-ocp}
...
* link:https://docs.redhat.com/en/documentation/red_hat_quay/{producty}/html-single/configure_red_hat_quay/index#config-fields-ssl[SSL/TLS configuration fields]
* link:https://docs.redhat.com/en/documentation/red_hat_quay/{producty}/html-single/release_notes/index#ocp-tls-security-profile-inheritance[{ocp} cluster TLS security profile inheritance]
...
include::modules/example-certificate-manager.adoc[leveloffset=+4]
