...
See the link:https://access.redhat.com/documentation/en-us/red_hat_quay/2.9/html-single/red_hat_quay_release_notes/index[Red Hat Quay Release Notes] for information on v3 features.
