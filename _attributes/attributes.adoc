...
:productname-ocp: {productname-ocp} Container Platform
:quayio: Quay.io
...
:clairproductminv: 4.9
:builderimage: quay-builder-rhel9
:builderqemuimage: quay-builder-qemu-rhcos
:postgresimage: registry.redhat.io/rhel9/postgresql-15
:redisimage: registry.redhat.io/rhel9/redis-6:latest
endif::[]