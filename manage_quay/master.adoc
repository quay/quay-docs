...
Use the content within this section to back up and restore your Red Hat Quay deployment on an OpenShift Container Platform deployment, or on a virtual machine.
