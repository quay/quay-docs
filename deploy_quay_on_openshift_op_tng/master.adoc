...
[NOTE]
====
This is a draft version of the {productname} 3.6 documentation and is NOT finalized or approved
====
...
include::modules/operator-preconfigure-automation.adoc[leveloffset=+2]
...
include::modules/operator-first-user-api.adoc[leveloffset=+3]
...
include::modules/operator-config-monitoring.adoc[leveloffset=+2]
