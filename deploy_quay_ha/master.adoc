...
{productname} is an enterprise-quality container registry. Use {productname} to build, store, and deploy containers to the servers across your enterprise. 

This document describes how to deploy a high availability, enterprise-quality
{productname} setup.
