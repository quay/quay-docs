...
[role="_abstract"] 
To automate container image builds from Dockerfiles in {productname}, you can configure builders on bare metal and virtual machines. Configure build triggers to start builds automatically when code changes occur, or start builds manually when needed.
