...
[role="_abstract"]
To automate container image builds from Dockerfiles in {productname}, you can configure bare metal and virtual builders and configure build triggers. Build triggers start builds when code changes occur, or you can start builds manually when needed.
