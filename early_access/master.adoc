...
[id="early-access"]
= Early access documentation for {productname} 

toc::[]

[id='quay-release-notes']
== {productname} {producty} Release Notes

{productname} is regularly released, containing new features, bug fixes, and software updates. Deploy the latest version of {productname} to ensure you are using the latest features, bug fixes, and software updates.

ifdef::downstream[]
For {productname} documentation:
...
////
[id="quay-config-fields-38"]
== Configuration field updates 
////

include::modules/config-updates-38.adoc[New configuration fields]

include::modules/testing-3-800.adoc[Testing {productname} 3.8 features]

////
[id='quay-release-notes']
== {productname} 3.7 Release Notes
