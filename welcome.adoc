...
xref:deploy_quay_on_openshift_op_v2.adoc[Deploy with the {productname} Operator on OpenShift (v2)]

xref:deploy_quay_on_openshift_op.adoc[Deploy with the legacy {productname} Operator on OpenShift (v1)]
