...
[id="deleteorgimmutabilitypolicy"]
= deleteOrgImmutabilityPolicy

[role="_abstract"]
Delete Org Immutability Policy.

[id="deleteorgimmutabilitypolicy-delete"]
...
[id="deleteorgimmutabilitypolicy-responses"]
== Responses
...
[id="deleteorgimmutabilitypolicy-example-command"]
== Example command
