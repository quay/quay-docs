...
[role="_abstract"]
Proxy caching in {productname} has size, property, and anonymous-user limitations. You can use these constraints to plan cache organization capacity and access.
