...
[role="_abstract"]
{productname} geo-replication synchronizes images across regions that must share storage, database, and network infrastructure. These requirements define what you must configure outside {productname} because geo-replication does not provide automatic failover, database replication, or storage health awareness.
