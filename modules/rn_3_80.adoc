...
[id="38-new-features-and-enhancements"]
...
+
For more information, see xref:enabling-ipv6-dual-stack[IPv6 Support]. 
...
+
For more information, see xref:enabling-ldap-super-users[Enabling LDAP superusers for {productname}].
...
*Default*: `true`
+
For more information, see xref:enabling-ui-v2[Enabling and testing FEATURE_UI_V2].
...
| xref:enabling-global-readonly-super-users[**GLOBAL_READONLY_SUPER_USERS**]
| General Availability
| -
| -
