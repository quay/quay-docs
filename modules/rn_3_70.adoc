...
[[rn-3-714]]
== RHBA-2023:5100 - {productname} 3.7.14 bug fix update 

Issued: 2023-09-12

{productname} release 3.7.14 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2023:5100[RHBA-2023:5100] advisory.

=== Bug fixes 

* link:https://issues.redhat.com/browse/PROJQUAY-6006[PROJQUAY-6006]. Quay Operator doesn't trust internal service CA when it is rotated.

[[rn-3-713]]
== RHBA-2023:4086 - {productname} 3.7.13 bug fix update 

Issued: 2023-07-20

{productname} release 3.7.13 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2023:4086[RHBA-2023:4086] advisory.

=== Bug fixes 

* link:https://issues.redhat.com/browse/PROJQUAY-5814[PROJQUAY-5814]. Update kube-rbac-proxy.

[[rn-3-712]]
== RHBA-2023:3805 - {productname} 3.7.12 bug fix update 

Issued: 2023-07-05

{productname} release 3.7.12 is now available. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHBA-2023:3805[RHBA-2023:3805] advisory.

=== Bug fixes 

* link:https://issues.redhat.com/browse/PROJQUAY-5617[PROJQUAY-5617]. Project Quay unable to mirror registry.ci.openshift.org
* link:https://issues.redhat.com/browse/PROJQUAY-5618[PROJQUAY-5618]. Enabling quota management in Quay significantly slows down opening of the super user panel
* link:https://issues.redhat.com/browse/PROJQUAY-5620[PROJQUAY-5620]. Quay operator pod can not deploy quay pods when set horizontalpodautoscaler as managed in OCP 4.13
