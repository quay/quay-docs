...
[id="createusernotification-post"]
...
[id="createusernotification-request-body-schema"]
...
[id="createusernotification-responses"]
== Responses
...
[id="createusernotification-example-command"]
== Example command
