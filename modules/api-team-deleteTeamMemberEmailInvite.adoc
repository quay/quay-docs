...
[id="deleteteammemberemailinvite-delete"]
...
[id="deleteteammemberemailinvite-path-parameters"]
== Path parameters
...
[id="deleteteammemberemailinvite-responses"]
== Responses
...
[id="deleteteammemberemailinvite-example-command"]
== Example command
+
[source,terminal]
----
