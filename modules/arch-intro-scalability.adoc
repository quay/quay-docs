...
=======
[role="_abstract"]
{productname} uses the same codebase as Quay.io, Red{nbsp}Hat's highly available container image registry. You can deploy at scale with high availability on-prem or in the cloud, with multitenant operation supported.
