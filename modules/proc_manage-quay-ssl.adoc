...
This document assumes you have deployed {productname} in a link:../../../deploy_quay/deploy_quay_single.adoc[single-node] or link:../../../deploy_quay/deploy_quay_ha.adoc[highly available] deployment.
