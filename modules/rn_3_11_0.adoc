...
* link:https://issues.redhat.com/browse/PROJQUAY-7541[PROJQUAY-7541]. Global read-only super user call some superuser APIs failed. 
* link:https://issues.redhat.com/browse/PROJQUAY-7544[PROJQUAY-7544]. Quay global readonly superuser can't get any resources from organization API.
* link:https://issues.redhat.com/browse/PROJQUAY-7548[PROJQUAY-7548]. Global read-only super user can't get correct information by calling API listRepos.
