...
[role="_abstract"]
Configuring SSL/TLS and routes for {productname} lets you control how TLS termination and route management work together. The `tls` component provides support for {ocp} edge termination routes and enables independent control of route management and TLS certificate handling.
