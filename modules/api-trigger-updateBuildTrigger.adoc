...
[id="updatebuildtrigger-path-parameters"]
== Path parameters
...
[id="updatebuildtrigger-request-body-schema"]
...
[id="updatebuildtrigger-responses"]
== Responses
...
[id="updatebuildtrigger-example-command"]
== Example command
