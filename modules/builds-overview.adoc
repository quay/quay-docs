...
[role="_abstract"]
The {productname} builds feature automates container image builds from Dockerfiles using worker nodes. You can trigger builds manually or automatically via webhooks to integrate CI/CD pipelines into your workflow.
...
_Builds_ are highly complex, and administrators are encouraged to review the Build automation architecture guide before continuing.
