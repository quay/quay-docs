...
* Immutable tags are excluded from auto-prune policies and cannot be opted back in. They can still be removed by per-tag expiration, including the `quay.expires-after` label or annotation.
