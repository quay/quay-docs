...
[role="_abstract"]
To update your on-premises {productname} configuration after deployment, you can edit the `config.yaml` file and restart the `quay-registry` container. You can retrieve the file from the container if you do not have direct access to it.
