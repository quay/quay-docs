...
[role="_abstract"]
To export repository logs from {productname}, you can use the Export Logs feature in the UI. You receive the exported data by email or callback URL, and it expires after a set time.
