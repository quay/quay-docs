...
[id="deleteuserautoprunepolicy-path-parameters"]
== Path parameters
...
[id="deleteuserautoprunepolicy-responses"]
== Responses
...
[id="deleteuserautoprunepolicy-example-command"]
== Example command
