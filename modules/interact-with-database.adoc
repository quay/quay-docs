...
[WARNING]
====
Interacting with the PostgreSQL database is potentially destructive. Red Hat recommends that you perform the following procedure with a {productname} Support Specialist. 
====
