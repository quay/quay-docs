...
[role="_abstract"]
To troubleshoot {productname} object storage and resolve issues with container image storage, you can use the procedures in this section. Object storage manages data as discrete units called objects, each with a unique identifier and metadata.
