...
[role="_abstract"]
To verify authentication and permissions for {productname} repository mirroring and resolve mirroring issues, you can ensure credentials have the necessary access on source and destination instances.
