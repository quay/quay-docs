...
[role="_abstract"]
Sample {productname} sizing tables list approximate resources for proof of concept, mid-size, and high-end deployments. You can use these figures as a starting point and adjust based on your workload.
...
.^| Database sizing| 2-4 Cores; 6-8 GB RAM; 10-20 GB disk
...
|  Redis cache sizing |  |  2 Cores; 2-4 GB RAM
| 4 cores; 28 GB RAM
