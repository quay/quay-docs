...
[id="metrics-general-registry-stats"]
= General registry statistics

[role="_abstract"]
Use these general registry statistics metrics to track how large a {productname} deployment has grown, including users, robots, organizations, repositories, and unscanned images.
