...
[id="changeuserquotasuperuser"]
= changeUserQuotaSuperUser

[role="_abstract"]
Change User Quota Super User.

[id="changeuserquotasuperuser-put"]
...
[id="changeuserquotasuperuser-path-parameters"]
== Path parameters
...
[id="changeuserquotasuperuser-request-body-schema"]
...
[id="changeuserquotasuperuser-responses"]
== Responses
...
[id="changeuserquotasuperuser-example-command"]
== Example command
