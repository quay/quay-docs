...
[role="_abstract"]
To create a mirrored organization in {productname} by using the API, you can send HTTP requests to the organization mirror endpoints with `curl` and an OAuth bearer token.
