...
[id="getorganizationquota"]
= getOrganizationQuota

[role="_abstract"]
Get Organization Quota.

[id="getorganizationquota-get"]
== GET /api/v1/organization/{orgname}/quota/{quota_id}



**Authorizations: **
[id="getorganizationquota-path-parameters"]
== Path parameters
...
[id="getorganizationquota-responses"]
== Responses
...
[id="getorganizationquota-example-command"]
== Example command
