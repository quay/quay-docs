...
* Fix Clair not recognizing python language vulnerabilities link:https://issues.redhat.com/browse/PROJQUAY-1775[PROJQUAY-1775]
* Fix Clair not honoring DisableUpdaters config option link:https://issues.redhat.com/browse/PROJQUAY-1759[PROJQUAY-1759]
