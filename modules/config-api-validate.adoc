...
[id="config-api-validate"]

= Validating configuration using the API

[role="_abstract"]
{productname} provides validating configuration using the API for registry administrators. You can use this information when you manage your deployment.
