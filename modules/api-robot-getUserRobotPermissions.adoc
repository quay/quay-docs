...
[id="getuserrobotpermissions-get"]
...
[id="getuserrobotpermissions-path-parameters"]
== Path parameters
...
[id="getuserrobotpermissions-responses"]
== Responses
...
[id="getuserrobotpermissions-example-command"]
== Example command
