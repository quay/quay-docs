...
[role="_abstract"]
Clair updaters fetch vulnerability data from distribution-specific and open source sources. You can use this table of updater URLs and components to configure Clair and proxy allowlists in {productname}.
