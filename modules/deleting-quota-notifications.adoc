...
[role="_abstract"]
To stop tracking storage thresholds or remove an inactive alerting endpoint in {productname}, you can delete quota notifications from organization or user namespaces.
