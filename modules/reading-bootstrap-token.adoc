...
[NOTE]
====
Secret propagation can take up to 60 seconds after renewal or initial provisioning. If the `token.json` key is missing, wait for the Quay application pods to finish starting and retry the command.
====
