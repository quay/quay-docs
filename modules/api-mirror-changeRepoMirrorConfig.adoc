...
[id="changerepomirrorconfig-path-parameters"]
== Path parameters
...
[id="changerepomirrorconfig-request-body-schema"]
...
[id="changerepomirrorconfig-responses"]
== Responses
...
[id="changerepomirrorconfig-example-command"]
== Example command
