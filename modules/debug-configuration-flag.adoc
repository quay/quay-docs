...
[role="_abstract"]
The DEBUG configuration flag in {productname} prevents builder instances from shutting down automatically after builds complete or fail. Set this flag to True to debug builder node issues.
