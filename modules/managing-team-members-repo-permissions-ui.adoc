...
[role="_abstract"]
To manage team members and set repository permissions for a team, you can use the {productname} UI. You can add or remove members, and adjust access levels for each repository.
