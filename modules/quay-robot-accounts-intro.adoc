...
For more information on robot accounts, see xref:../../adoc-single/manage_red_hat_quay/index#mirroring-working-with[Working with mirrored repositories]

mirroring-working-with.adoc#mirroring-working-with[Working with mirrored repositories]
