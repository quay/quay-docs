...
[id="deleteorgnotification"]
= deleteOrgNotification

[role="_abstract"]
Delete Org Notification.

[id="deleteorgnotification-delete"]
...
[id="deleteorgnotification-path-parameters"]
== Path parameters
...
[id="deleteorgnotification-responses"]
== Responses
...
[id="deleteorgnotification-example-command"]
== Example command
