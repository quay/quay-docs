...
[role="_abstract"]
To configure a custom Clair database with SSL/TLS certificates on {productname}, you can create a Quay configuration bundle secret that includes the `clair-config.yaml` file.
