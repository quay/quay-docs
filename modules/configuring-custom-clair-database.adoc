...
[role="_abstract"]
To configure a custom Clair database with SSL/TLS certificates for your {productname} deployment, you can create a Quay configuration bundle secret that includes the `clair-config.yaml` file. This lets you use your own external database with secure connections for Clair vulnerability scanning.
