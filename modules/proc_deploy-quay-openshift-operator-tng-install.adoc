...
```
+
This concludes the setup of the _Multi-Cloud Object Gateway_ instance for Red Hat Quay. Note that this configuration cannot be run in parallel on the same cluster with Red Hat OpenShift Data Foundations installed.
```
endif::[]
