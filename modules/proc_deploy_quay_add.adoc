...
link:https://access.redhat.com/documentation/en-us/red_hat_quay/3/html-single/manage_red_hat_quay/index#enable_clair_in_other_red_hat_quay_deployments[Enable {productname} in other deployments].
