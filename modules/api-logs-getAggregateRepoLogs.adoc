...
[id="getaggregaterepologs-path-parameters"]
== Path parameters
...
[id="getaggregaterepologs-query-parameters"]
== Query parameters
...
[id="getaggregaterepologs-responses"]
== Responses
...
[id="getaggregaterepologs-example-command"]
== Example command
[source,terminal]
----
$ curl -X GET \
