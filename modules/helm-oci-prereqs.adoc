...
[role="_abstract"]
Before you use Helm charts with {productname}, you can install a supported Helm client and trust registry certificates. OCI chart support requires a compatible Helm version.
...
* link:https://github.com/helm/helm/releases[Helm releases]
