...
[id="config-api-required"]

= Determining the required fields

[role="_abstract"]
{productname} provides determining the required fields for registry administrators. You can use this information when you manage your deployment.
