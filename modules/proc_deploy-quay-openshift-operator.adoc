...
you will need to specify the hostname location for which the setup process
can use.
...
that Quay Operator v3.3.0 specifically supports Quay v3.3.0 and Clair v3.3.0.
