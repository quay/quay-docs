...
[role="_abstract"]
To assign a role to a team within an {productname} organization, you can use the UI. Team roles determine a member's permissions, such as administrative or contributor access.
