...
[id="createorganizationautoprunepolicy-path-parameters"]
== Path parameters
...
[id="createorganizationautoprunepolicy-request-body-schema"]
...
[id="createorganizationautoprunepolicy-responses"]
== Responses
...
[id="createorganizationautoprunepolicy-example-command"]
== Example command
