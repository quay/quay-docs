...
[role="_abstract"]
To install Cosign and sign images in {productname}, you can generate a key pair, sign a tag, and verify the signature. You authenticate to the registry with your existing credentials.
