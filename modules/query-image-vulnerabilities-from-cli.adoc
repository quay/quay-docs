...
[role="_abstract"]
To check for security vulnerabilities in your {productname} container images, you can query vulnerability information from the command line using the `oc get vuln` command. You can also view detailed information about specific vulnerabilities by using the `oc describe vuln` command.
