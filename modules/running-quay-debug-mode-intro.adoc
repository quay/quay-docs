...
[role="_abstract"]
To gather debugging information for support cases and troubleshoot issues, you can run {productname} in debug mode. Debug mode provides verbose logging that speeds up reproducing errors and supports root cause analysis for geo-replication, Operator, standalone deployments, and object storage.
