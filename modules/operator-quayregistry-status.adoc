...
+
If the registry status shows `RolloutBlocked`, check the condition message and Events for details. Invalid PostgreSQL TLS configuration, such as a missing or expired certificate Secret, also sets `RolloutBlocked`.