...
[role="_abstract"]
To alert users to repository events such as pushes or build failures, you can create a notification from the *Settings* page in the {productname} v2 UI. You select an event trigger and a delivery method, such as email or Slack.
