...
[role="_abstract"]
To enable features for your {productname} registry, you can edit the `configBundleSecret` resource using the {ocp} web console. The Operator automatically reconciles changes by restarting Quay-related pods.
