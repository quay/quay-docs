...
[id="createorganizationapplicationtoken-path-parameters"]
== Path parameters
...
[id="createorganizationapplicationtoken-request-body-schema"]
...
[id="createorganizationapplicationtoken-responses"]
== Responses
...
[id="createorganizationapplicationtoken-example-command"]
== Example command
