...
[role="_abstract"]
Organizations in {quayio} group users, repositories, and teams under a shared namespace for centralized access control. Administrators can assign roles and permissions to teams and users within an organization.
...
[role="_abstract"]
Organizations in {productname} group users, repositories, and teams under a shared namespace for centralized access control. Administrators can assign roles and permissions to teams and users within an organization.
