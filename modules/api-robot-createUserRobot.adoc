...
[id="createuserrobot-path-parameters"]
== Path parameters
...
[id="createuserrobot-request-body-schema"]
...
[id="createuserrobot-example-command"]
== Example command
