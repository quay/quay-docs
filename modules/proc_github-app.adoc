...
[role="_abstract"]
To enable GitHub integration for automated builds in {productname}, you can create an OAuth application in GitHub. This allows {productname} to access GitHub repositories and trigger container image builds when commits or pull requests are made.
