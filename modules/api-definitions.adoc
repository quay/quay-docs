...
|Name|Description|Schema
|**name** +
_optional_|The organization name.|string
|**email** +
_optional_|The organization contact email. For backward compatibility, returns the value of `contact_email`.|string
|**contact_email** +
_optional_|Central email address for receiving automated system alerts. This field is decoupled from the user account identity. Additionally, the field allows multiple organizations to share the same email address.|string or null
|**avatar** +
_optional_|Avatar information for the organization.|object
|**is_admin** +
_optional_|Determines if the current user is an admin of the organization.|boolean
|**is_member** +
_optional_|Determines if the current user is a member of the organization.|boolean
|**teams** +
_optional_|If the user is a member of the organization, states the team within the organization.|object
|**ordered_teams** +
_optional_|Alphabetically ordered list of team names.|array of strings
|**invoice_email** +
_optional_|Determines if an invoice email is set.|boolean
|**invoice_email_address** +
_optional_|If set, specifies the invoice email address.|string or null
|**tag_expiration_s** +
_optional_|Tag expiration time in seconds.|integer
|**is_free_account** +
_optional_|Specifies a free account.|boolean
|===
