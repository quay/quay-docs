...
[role="_abstract"]
To install the {productname} Operator from the {ocp} OperatorHub, you can configure the installation mode and update approval strategy. Install the Operator cluster-wide to ensure the monitoring component is available.
