...
* If you have already deployed {productname-ocp} using the Operator, you must perform one of two actions:
** You must remove the installed Operator and any specific namespace that you created for the deployment.
