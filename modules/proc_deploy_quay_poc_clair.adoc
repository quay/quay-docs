...
. In your installation folder, denoted here by the variable $QUAY, create a directory for Clair configuration. The following example provides a minimal configuration for use in a proof of concept deployment:
