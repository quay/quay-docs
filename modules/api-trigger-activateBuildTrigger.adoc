...
[id="activatebuildtrigger-path-parameters"]
== Path parameters
...
[id="activatebuildtrigger-request-body-schema"]
...
[id="activatebuildtrigger-responses"]
== Responses
...
[id="activatebuildtrigger-example-command"]
== Example command
