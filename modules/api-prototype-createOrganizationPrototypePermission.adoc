...
[id="createorganizationprototypepermission-post"]
...
[id="createorganizationprototypepermission-path-parameters"]
== Path parameters
...
[id="createorganizationprototypepermission-request-body-schema"]
...
[id="createorganizationprototypepermission-responses"]
== Responses
...
[id="createorganizationprototypepermission-example-command"]
== Example command
