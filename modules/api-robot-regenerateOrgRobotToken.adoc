...
[id="regenerateorgrobottoken-post"]
...
[id="regenerateorgrobottoken-path-parameters"]
== Path parameters
...
[id="regenerateorgrobottoken-responses"]
== Responses
...
[id="regenerateorgrobottoken-example-command"]
== Example command
