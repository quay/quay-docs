...
[role="_abstract"]
To replace a compromised or expired credential, you can regenerate a robot account token by using the {productname} API. You can regenerate tokens for both organization and user robot accounts.
