...
[role="_abstract"]
To review robot account details and permissions for an organization or user in {productname}, you can call the robot account API endpoints with an OAuth access token.
