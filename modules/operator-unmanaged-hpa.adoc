...
[role="_abstract"]
To customize scaling thresholds or replica limits for your {productname} registry, you can set the `horizontalpodautoscaler` component to unmanaged in the `QuayRegistry` custom resource. You can then explicitly set replica counts for the `quay`, `clair`, and `mirror` components.
