...
[role="_abstract"]
The following configuration fields allow {productname} to connect to your SMTP server. With these fields, you can send account confirmation, password reset, and security alerts.
