...
https://<quay-server.example.com>/api/v1/superuser/organizations/<orgname>
----
+
[NOTE]
====
Setting the contact email requires superuser privileges. If a contact email is not set, quota notifications are sent to organization administrator email addresses.
====
