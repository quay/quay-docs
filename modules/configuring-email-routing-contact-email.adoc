...
[role="_abstract"]
To route quota notification emails to a shared organization contact address in {productname}, you can set the organization contact email with the API. You can list and test notifications for organizations and user namespaces.
