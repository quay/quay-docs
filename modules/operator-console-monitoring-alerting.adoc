...
[role="_abstract"]
{productname} provides monitoring and alerting features in the {ocp} console for instances deployed by the Operator. You can use Grafana dashboards, individual metrics, and alerts to monitor registry performance and receive notifications when Quay pods restart frequently.
