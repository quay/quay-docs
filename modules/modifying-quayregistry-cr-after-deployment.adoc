...
[role="_abstract"]
Modifying the `QuayRegistry` custom resource (CR) in {productname} after deployment lets you customize or reconfigure aspects of your {productname} environment.
