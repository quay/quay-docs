...
* Assigned the *Member* team role. For more information about team roles, see link:https://docs.redhat.com/en/documentation/red_hat_quay/3/html/use_red_hat_quay/user-org-intro_use-quay#tenancy-model[{productname} tenancy model].
