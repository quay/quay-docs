...
[role="_abstract"]
To proxy a remote registry with {productname}, you can configure an organization as a cache and pull images through it. You set the remote registry, optional credentials, and expiration on the UI.
