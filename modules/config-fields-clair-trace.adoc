...
[role="_abstract"]
You can use the Clair trace configuration fields to configure OpenTelemetry and Jaeger distributed tracing for Clair in {productname}.
...
[id="config-fields-clair-trace-example"]
