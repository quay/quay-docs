...
[role="_abstract"]
To configure Amazon EC2 instances as build worker nodes in {productname}, you can modify your configuration bundle to use EC2 executors. This provides a backup solution when your OpenShift build workers are overloaded or unavailable.
