...
[IMPORTANT]
====
This feature configures transport encryption for Operator-managed PostgreSQL. It is distinct from the managed `tls` component, which handles {productname}'s external HTTPS endpoint.
====
