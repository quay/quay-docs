...
[role="_abstract"]
To automatically synchronize container images between registries, you can use the {productname} UI to create a mirroring organization.
...
* You have a {productname} organization with sufficient permissions.
