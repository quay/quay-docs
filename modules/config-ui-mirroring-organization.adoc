...
= Enabling mirroring for an organization with the web console

[role="_abstract"]
To automatically synchronize container images between registries, you can use the {productname} web console to enable mirroring for your {productname} organization. Configuring this automated synchronization ensures that your deployment always has access to the most up-to-date container files.
