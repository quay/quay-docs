...
Further information about Red Hat Ceph Storage and HA setups can be found in the link:https://docs.redhat.com/en/documentation/red_hat_ceph_storage/5/html-single/architecture_guide/index[Red Hat Ceph Storage Architecture Guide]
