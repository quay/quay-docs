...
[id="createorganizationquotalimit"]
= createOrganizationQuotaLimit

[role="_abstract"]
Create Organization Quota Limit.

[id="createorganizationquotalimit-post"]
...
[id="createorganizationquotalimit-path-parameters"]
== Path parameters
...
[id="createorganizationquotalimit-request-body-schema"]
...
[id="createorganizationquotalimit-responses"]
== Responses
...
[id="createorganizationquotalimit-example-command"]
== Example command
