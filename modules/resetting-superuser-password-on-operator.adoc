...
[role="_abstract"]
To reset the superuser password on your {productname} Operator deployment, you can generate a bcrypt-hashed password with Python, log in to the PostgreSQL database with `oc rsh` and `psql`, and update the user table with the new hashed password.
