...
. To obtain tag information, you must use the link:https://docs.redhat.com/en/documentation/red_hat_quay/3/html-single/red_hat_quay_api_guide/index#getrepo[`GET /api/v1/repository/{repository}`] API endpoint and pass in the `includeTags` parameter. For example:
+
[source,terminal]
----
$ curl -X GET \
...
. Alternatively, you can use the link:https://docs.redhat.com/en/documentation/red_hat_quay/3/html-single/red_hat_quay_api_guide/index#listrepotags[`GET /api/v1/repository/{repository}/tag/`] endpoint. For example:
+
[source,terminal]
----
$ curl -X GET \
