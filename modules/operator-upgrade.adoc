...
==== Configuring Claire v4 when upgrading from 3.3.* to 3.6 using the Quay Operator 
...
==== Configuring Claire v4 when performing a standalone upgrade from 3.3.* to 3.6 
