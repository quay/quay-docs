...
[role="_abstract"]
The tenancy model describes users, organizations, teams, and robot accounts in {productname}. You can use these entities to control repository access and collaboration.
