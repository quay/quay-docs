...
[role="_abstract"]
On {productname-ocp}, additional Certificate Authorities (CAs) in the configuration bundle are added to the registry trust store. {productname} uses these CAs to verify TLS connections to external services.
