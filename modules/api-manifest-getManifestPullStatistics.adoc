...
[id="getmanifestpullstatistics-path-parameters"]
== Path parameters
...
[id="getmanifestpullstatistics-responses"]
== Responses
...
[id="getmanifestpullstatistics-example-command"]
== Example command
