...
[role="_abstract"]
To remove a geo-replicated site from a {productname-ocp} deployment, you can sync blobs between sites, update storage configuration, and run the `removelocation` utility.
