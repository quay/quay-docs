...
[role="_abstract"]
To troubleshoot {ocp} and Kubernetes builds in {productname}, you can create a port forwarding tunnel to the builder pod and access it via SSH. Check the quay-builder service logs to diagnose build issues.
