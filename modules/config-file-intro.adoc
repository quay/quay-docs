...
[NOTE]
====
It is possible to use the configuration API to validate the configuration, but this requires starting the Quay container in configuration mode. For more information, see xref:Using the configuration tool[Using the configuration tool]. 
====
