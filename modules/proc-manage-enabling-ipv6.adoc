...
[role="_abstract"]
To enable IPv6 support on your {productname} deployment, you can add the `FEATURE_LISTEN_IP_VERSION` parameter to your `config.yaml` file and set it to IPv6. Restart your deployment to apply the change.
