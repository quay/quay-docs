...
* link:https://issues.redhat.com/browse/PROJQUAY-7177[PROJQUAY-7177]. Quay global readonly superuser can't get any resources from organization API.

* link:https://issues.redhat.com/browse/PROJQUAY-7446[PROJQUAY-7446]. Global read-only super user can't get correct information by calling API listRepos.

* link:https://issues.redhat.com/browse/PROJQUAY-7449[PROJQUAY-7449]. Global read-only super user call some superuser APIs failed.

* link:https://issues.redhat.com/browse/PROJQUAY-7487[PROJQUAY-7487]. Wrong type of event propagated when multiple policy for tag expiration trigger.	

* link:https://issues.redhat.com/browse/PROJQUAY-7491[PROJQUAY-7491]. Presigned S3 request computed by Quay using signature-version v2.

* link:https://issues.redhat.com/browse/PROJQUAY-7109[PROJQUAY-7109]. Can not filter logs by keywords in the new UI.

* link:https://issues.redhat.com/browse/PROJQUAY-7467[PROJQUAY-7467]. Quay 3.12 new UI can't display the date row in the chart of usage logs page.

* link:https://issues.redhat.com/browse/PROJQUAY-7425[PROJQUAY-7425]. Quay Clair can't scan images when using NetApp ONTAP S3 Object Storage.

* link:https://issues.redhat.com/browse/PROJQUAY-6562[PROJQUAY-6562]. Too many INFO log lines in quay-app logs.
