...
[role="_abstract"]
To configure your custom Git trigger, you can obtain the SSH public key and webhook endpoint URL from the {productname} user interface. These credentials are available on the *Builds* page of your repository.
