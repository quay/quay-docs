...
[role="_abstract"]
To configure federation audiences for robot accounts in {productname}, you can use the robot federation API. Audience validation depends on stored federation configuration.
