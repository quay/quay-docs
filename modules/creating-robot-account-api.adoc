...
[role="_abstract"]
To automate access to your repositories, you can create a robot account by using the {productname} API. You can create robot accounts for an organization or for your own user account.
