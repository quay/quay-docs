...
[role="_abstract"]
An image tag identifies a specific version or variant of a container image in {productname}. You can use tags to manage versioning, rollbacks, environment-specific builds, and CI/CD workflows for your images.
