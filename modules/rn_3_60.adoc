...
* Users can now view Clair v4.2 enrichment data in the Quay UI. Additionally, Clair v4.2 now adds CVSS scores from the National Vulnerability Database for detected vulnerabilities. Quay's UI will prefer displaying the CVSS score when a more specific severity is not available. (link:https://issues.redhat.com/browse/PROJQUAY-2102?filter=12382147[PROJQUAY-2102]) (link:https://issues.redhat.com/browse/PROJQUAY-1724?filter=12382147[PROJQUAY-1724]) 
