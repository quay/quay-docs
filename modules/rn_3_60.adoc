...
* Clair v4.1.0.alpha2 indexer now works in {product-name} 3.6. (link:https://issues.redhat.com/browse/PROJQUAY-1918?filter=12382147[PROJQUAY-1918])

* The `initContainer` from the Quay migration pod has been removed, which blocked the deployment process until Clair responded. As a result, Quay deployments now progress without waiting on the Clair deployment to finish. (link:https://issues.redhat.com/browse/PROJQUAY-1610?filter=12382147[PROJQUAY-1610]) 
...
(link:https://issues.redhat.com/browse/PROJQUAY-1583?filter=12382147[PROJQUAY-1583])
