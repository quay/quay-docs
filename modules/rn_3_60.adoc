...
* Users can now view Clair v4.2 enrichment data in the Quay UI. Additionally, Clair v4.2 now adds CVSS scores from the National Vulnerability Database for detected vulnerabilities. 
+
