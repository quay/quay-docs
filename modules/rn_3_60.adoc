...
* link:https://issues.redhat.com/browse/PROJQUAY-4315[PROJQUAY-4315]. cert_install.sh script incorrectly parses certificates in certain situations. 
...
link:https://issues.redhat.com/browse/PROJQUAY-3165[PROJQUAY-3165]. Supported nginx version in Quay's container.
...
* link:https://issues.redhat.com/browse/PROJQUAY-3886[PROJQUAY-3886]. Add missing FIPS and Proxy-Awareness badges to the Operator.

* link:https://issues.redhat.com/browse/PROJQUAY-3753[PROJQUAY-3753]. Pushing big layers to Quay deployed on Azure OpenShift Cluster results in a 413.
