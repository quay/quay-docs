==  Migrating a standalone Quay deployment to a {productname} Operator managed deployment
...
== Migrating a standalone {productname} deployment to OpenShift Container Platform.
