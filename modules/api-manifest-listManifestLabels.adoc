...
[id="listmanifestlabels-path-parameters"]
== Path parameters
...
[id="listmanifestlabels-query-parameters"]
== Query parameters
...
[id="listmanifestlabels-responses"]
== Responses
...
[id="listmanifestlabels-example-command"]
== Example command
[source,terminal]
----
$ curl -X GET \
