...
[role="_abstract"]
After you create a mirrored repository in {productname}, you can enable or disable mirroring, sync on demand, update credentials, and manage robot account permissions.
...
* *Set robot permissions*: {productname} robot accounts are named tokens that hold credentials for accessing external repositories. By assigning credentials to a robot, that robot can be used across multiple mirrored repositories that need to access the same external registry.
+
