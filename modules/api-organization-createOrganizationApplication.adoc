...
[id="createorganizationapplication-post"]
...
[id="createorganizationapplication-path-parameters"]
== Path parameters
...
[id="createorganizationapplication-request-body-schema"]
...
[id="createorganizationapplication-responses"]
== Responses
...
[id="createorganizationapplication-example-command"]
== Example command
[source,terminal]
----
