...
. Enter the following command to deploy the Swagger UI container, pointing the URL to your {productname} API discovery endpoint. For example:
+
[source,terminal]
----
...
. Navigate to the `localhost` URL. In this example, the URL is *http://localhost:8080/*.
