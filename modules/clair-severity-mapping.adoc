...
[role="_abstract"]
Clair maps severity strings from multiple security databases to a common set of values. You can use the mapped severities to assess vulnerabilities consistently.
