...
[id="createrepomirrorconfig-path-parameters"]
== Path parameters
...
[id="createrepomirrorconfig-request-body-schema"]
...
[id="createrepomirrorconfig-responses"]
== Responses
...
[id="createrepomirrorconfig-example-command"]
== Example command
