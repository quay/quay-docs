...
[role="_abstract"]
To run an upstream Clair image with {productname}, you can stop the current Clair container, pull an image from the upstream repository, and start Clair with your existing configuration.
