...
* Use the link:https://docs.redhat.com/en/documentation/red_hat_quay/{producty}/html-single/red_hat_quay_api_guide/index#listalllogs[`GET /api/v1/superuser/logs`] endpoint to list the usage logs for the current system:
+
[source,terminal]
----
$ curl -X GET \
...
* Use the link:https://docs.redhat.com/en/documentation/red_hat_quay/{producty}/html-single/red_hat_quay_api_guide/index#getregistrysize[`GET /api/v1/superuser/registrysize/`] end point to obtain information about the size of the registry:
+
[source,terminal]
----
$ curl -X GET \
...
----
* Use the link:https://docs.redhat.com/en/documentation/red_hat_quay/{producty}/html-single/red_hat_quay_api_guide/index#getregistrysize[`POST /api/v1/superuser/registrysize/`] end point to define registry size information:
+
[source,terminal]
----
