...
[role="_abstract"]
To obtain configuration information for your {productname} deployment and troubleshoot issues, you can use `oc exec`, `oc cp`, or `oc rsync` for Operator deployments. Use these options to update your `config.yaml` file, search the Red Hat Knowledgebase, or file a support ticket.
