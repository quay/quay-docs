...
[role="_abstract"]
To deploy a basic {productname} registry instance, you can use the `oc` CLI to create a `QuayRegistry` custom resource. You configure managed or unmanaged object storage during the deployment process.
