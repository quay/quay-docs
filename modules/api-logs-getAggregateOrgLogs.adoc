...
[id="getaggregateorglogs-path-parameters"]
== Path parameters
...
[id="getaggregateorglogs-query-parameters"]
== Query parameters
...
[id="getaggregateorglogs-responses"]
== Responses
...
[id="getaggregateorglogs-example-command"]
== Example command
[source,terminal]
----
$ curl -X GET \
