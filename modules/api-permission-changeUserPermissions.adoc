...
[id="changeuserpermissions-path-parameters"]
== Path parameters
...
[id="changeuserpermissions-request-body-schema"]
...
[id="changeuserpermissions-responses"]
== Responses
...
[id="changeuserpermissions-example-command"]
== Example command
