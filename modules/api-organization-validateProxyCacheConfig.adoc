...
[id="validateproxycacheconfig"]
= validateProxyCacheConfig

[role="_abstract"]
Validate Proxy Cache Config.

[id="validateproxycacheconfig-post"]
== POST /api/v1/organization/{orgname}/validateproxycache



**Authorizations: **
[id="validateproxycacheconfig-path-parameters"]
== Path parameters
...
[id="validateproxycacheconfig-request-body-schema"]
...
[id="validateproxycacheconfig-responses"]
== Responses
...
[id="validateproxycacheconfig-example-command"]
== Example command
[source,terminal]
----
