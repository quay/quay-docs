...
Namespace auto-pruning policies are created using the {productname} v2 UI. This can be done after you have configured your {productname} `config.yaml` file to enable the auto-pruning feature and the v2 UI.
...
Use the following procedure to create an auto-prune policy using the {productname} v2 UI.
