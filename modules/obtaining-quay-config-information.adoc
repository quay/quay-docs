...
[role="_abstract"]
To identify and resolve {productname} configuration issues, you can check the configuration YAML. You can verify parameters, resource limits, connectivity, authentication, replication, and backup settings.
