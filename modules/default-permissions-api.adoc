...
[role="_abstract"]
To create, update, or delete default permissions for an {productname} organization, you can use the API. Default permissions grant access when a repository is created.
