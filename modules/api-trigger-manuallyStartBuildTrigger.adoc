...
[id="manuallystartbuildtrigger-post"]
...
[id="manuallystartbuildtrigger-path-parameters"]
== Path parameters
...
[id="manuallystartbuildtrigger-request-body-schema"]
...
[id="manuallystartbuildtrigger-responses"]
== Responses
...
[id="manuallystartbuildtrigger-example-command"]
== Example command
