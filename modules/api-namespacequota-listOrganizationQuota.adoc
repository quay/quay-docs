...
[id="listorganizationquota"]
= listOrganizationQuota

[role="_abstract"]
List Organization Quota.

[id="listorganizationquota-get"]
== GET /api/v1/organization/{orgname}/quota



**Authorizations: **
[id="listorganizationquota-path-parameters"]
== Path parameters
...
[id="listorganizationquota-responses"]
== Responses
...
[id="listorganizationquota-example-command"]
== Example command
