...
[id="changeorganizationquotasuperuser"]
= changeOrganizationQuotaSuperUser

[role="_abstract"]
Change Organization Quota Super User.

[id="changeorganizationquotasuperuser-put"]
...
[id="changeorganizationquotasuperuser-path-parameters"]
== Path parameters
...
[id="changeorganizationquotasuperuser-request-body-schema"]
...
[id="changeorganizationquotasuperuser-responses"]
== Responses
...
[id="changeorganizationquotasuperuser-example-command"]
== Example command
