...
[role="_abstract"]
To enable filesystem-independent bootstrap OAuth token provisioning for {productname-ocp}, you can add the programmatic bootstrap fields to the `configBundleSecret` resource.
