...
[role="_abstract"]
{productname} subscriptions are based on deployments and include Standard or Premium support. You can review subscription models and entitlements when planning your registry deployment.
...
* link:https://www.redhat.com/en/technologies/cloud-computing/quay[{productname}]
