...
[id="listorganizationapplicationtokens-path-parameters"]
== Path parameters
...
[id="listorganizationapplicationtokens-query-parameters"]
== Query parameters
...
[id="listorganizationapplicationtokens-responses"]
== Responses
...
[id="listorganizationapplicationtokens-example-command"]
== Example command
