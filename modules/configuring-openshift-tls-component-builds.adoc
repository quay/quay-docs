...
[role="_abstract"]
To enable the builds feature with unmanaged TLS in {product-title}, you can add the builder route name to the Subject Alternative Name (SAN) field in your SSL/TLS certificate configuration.
