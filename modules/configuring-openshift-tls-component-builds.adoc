...
[role="_abstract"]
To enable the builds feature with unmanaged TLS in {productname}, you can add the builder route name to the Subject Alternative Name (SAN) field in your SSL/TLS certificate configuration.
