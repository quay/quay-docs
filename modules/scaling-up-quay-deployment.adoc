...
`spec.components.horizontalpodautoscaler.managed`:: Specifies re-enabling auto scaling of Quay, Clair and Mirroring workers again.
`spec.components.quay`:: Specifies that replica overrides are removed again to scale the Quay components back up.
