...
[role="_abstract"]
To enable custom SSL/TLS certificates on your {productname} deployment, you can copy certificate files to your configuration directory and update the `config.yaml` file to use HTTPS. You can then restart the registry container to apply the SSL/TLS configuration.
