...
[role="_abstract"]
To create an image repository in {productname}, you can use the API.

ifeval::["{context}" == "quay-security"]
Private repositories can be created by using the API and specifying the visibility": `private`` option.
endif::[]
