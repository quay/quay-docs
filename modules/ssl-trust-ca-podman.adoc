...
[role="_abstract"]
To configure Podman to trust your self-signed certificate authority for {productname}, you can copy the root CA to the hostname-specific certificate directory under `/etc/containers/certs.d/` or `/etc/docker/certs.d/`.
.Procedure
