...
[role="_abstract"]
The following configuration fields manage automated builds within {productname}. These settings control how Dockerfile builds are triggered, processed, and stored, and how build logs are managed and accessed.
