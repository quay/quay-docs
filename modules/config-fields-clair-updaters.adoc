...
[role="_abstract"]
You can use the Clair updaters configuration fields to select which updater sets run and to pass updater-specific options in {productname}.
...
[id="config-fields-clair-updaters-example"]
