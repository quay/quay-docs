...
[role="_abstract"]
You can review configuration fields that are new or changed in {productname} 3.18, including OIDC multi-issuer settings, QuayRegistry TLS fields, and programmatic bootstrap options.
