...
the URL would be `https://quay.io/repository/abcsales/myweb?tab=tags`) on Quay.io. For a Red Hat Quay registry, replace `quay.io` with your registry name.
...
image:../../images/squash_image.png[Identify image to squash and download]
