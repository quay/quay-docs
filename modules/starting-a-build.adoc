...
[role="_abstract"]
Starting a build creates a container image from a Dockerfile in {productname}. You can start builds manually by uploading a Dockerfile or automatically by using build triggers.
