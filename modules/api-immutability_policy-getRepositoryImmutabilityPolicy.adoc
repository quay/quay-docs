...
[id="getrepositoryimmutabilitypolicy"]
= getRepositoryImmutabilityPolicy

[role="_abstract"]
Get Repository Immutability Policy.

[id="getrepositoryimmutabilitypolicy-get"]
...
[id="getrepositoryimmutabilitypolicy-responses"]
== Responses
...
[id="getrepositoryimmutabilitypolicy-example-command"]
== Example command
