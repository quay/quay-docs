...
[role="_abstract"]
To view or audit which tags are protected, you can list immutability policies for an organization or a repository in {productname} by using the API. Send `GET` requests with your bearer token to retrieve all policies or a single policy by UUID.
