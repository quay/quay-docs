...
+
Figure 2 shows an example of the {product_name} Setup screen as the database schema is set up.
+
...
+
Figure 3 shows an example of the {product_name} Setup screen for setting up a Quay superuser account:
+
