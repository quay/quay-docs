...
When the *DEFAULT_SYSTEM_REJECT_QUOTA_BYTES* field is set, and the quota limit has been met, the system automatically rejects new artifacts. By default, this configuration field is disabled. 
