...
[id="deleterepositoryautoprunepolicy-path-parameters"]
== Path parameters
...
[id="deleterepositoryautoprunepolicy-responses"]
== Responses
...
[id="deleterepositoryautoprunepolicy-example-command"]
== Example command
