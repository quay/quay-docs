...
[role="_abstract"]
To create an image expiration notification in {productname}, you can use the v2 UI or the API. You set how many days before expiry to send the alert.
...
`NOTIFICATION_TASK_RUN_MINIMUM_INTERVAL_MINUTES`:: Specifies that by default, this field is set to `300`, or 5 hours.
