...
link:https://access.redhat.com/documentation/en-us/red_hat_quay/3/html-single/release_notes#rn-1-141[Link to this Release]
...
link:https://access.redhat.com/documentation/en-us/red_hat_quay/3/html-single/release_notes#rn-1-140[Link to this Release]
