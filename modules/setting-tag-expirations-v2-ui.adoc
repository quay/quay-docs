...
[NOTE]
====
Immutable tags are excluded from auto-pruning, but they can still expire. To retire a locked production tag, use per-tag expiration instead of an auto-prune policy.
====
