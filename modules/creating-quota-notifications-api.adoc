...
[role="_abstract"]
To create quota warning or error notifications for organization and user namespaces in {productname}, you can use the API. Warning limits trigger `quota_warning` events and reject limits trigger `quota_error` events.
