...
[id="changeinstalluser"]
= changeInstallUser

[role="_abstract"]
Updates information about the specified user.

[id="changeinstalluser-put"]
...
[id="changeinstalluser-path-parameters"]
== Path parameters
...
[id="changeinstalluser-request-body-schema"]
...
[id="changeinstalluser-responses"]
== Responses
...
[id="changeinstalluser-example-command"]
== Example command
