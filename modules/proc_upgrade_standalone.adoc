...
In general, {productname} supports upgrades from a prior (N-1) minor version only.  For example, upgrading directly from v3.0.5 to v3.5.latest is not supported.  You will need to first upgrade from v3.0.5 to v3.1.3 to v3.2.2 to v3.3.4 to v3.4.latest and finally to v3.5.latest.  This is required to ensure that any necessary database migrations are done correctly and in the right order during the upgrade.


// TODO 36 Expand on standalone upgrade from 33->36, 34->36
[NOTE]
====
{productname} v3.6 supports direct, single-step upgrade from v3.3.* and from v3.4.*. This exception to the normal, prior minor version-only, upgrade simplifies the upgrade procedure for customers on older releases.
====
...
* Upgrade to v3.6.latest from v3.5.*
* Upgrade to v3.6.latest from v3.4.*
* Upgrade to v3.6.latest from v3.3.*
* Upgrade to v3.5.latest from v3.4.*
* Upgrade to v3.4.latest from v3.3.* 
...
Upgrading to {productname} 3.6 from v3.4.* requires a database migration which does not support downgrading back to a prior version of {productname}. Please back up your database before performing this migration.
...
Upgrading to {productname} 3.6 from v3.3.* requires a database migration which does not support downgrading back to a prior version of {productname}. Please back up your database before performing this migration.
...
=== Target images
* **Quay:** {productrepo}/{quayimage}:3.5.7
* **Clair:** {productrepo}/{clairimage}:3.5.7
* **PostgreSQL:** registry.redhat.io/rhel8/postgresql-10:1
* **Redis:** registry.redhat.io/rhel8/redis-5:1


== Upgrade to v3.4.6 from v3.3.* 
...
=== Target images
* **Quay:** {productrepo}/{quayimage}:3.4.6
* **Clair:** {productrepo}/{clairimage}:3.4.6
* **PostgreSQL:** registry.redhat.io/rhel8/postgresql-10:1
* **Redis:** registry.redhat.io/rhel8/redis-5:1
