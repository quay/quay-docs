...
[role="_abstract"]
To configure bare metal builds for {productname-ocp} with {product-title}, you can create a build project, configure service accounts, and update your configuration file.
