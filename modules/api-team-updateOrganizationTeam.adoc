...
[id="updateorganizationteam-path-parameters"]
== Path parameters
...
[id="updateorganizationteam-request-body-schema"]
...
[id="updateorganizationteam-responses"]
== Responses
...
[id="updateorganizationteam-example-command"]
== Example command
