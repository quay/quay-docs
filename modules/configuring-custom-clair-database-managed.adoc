...
[role="_abstract"]
To supply a custom `clair-config.yaml` while the Operator manages Clair on {productname}, you can create a Quay configuration bundle secret that includes your Clair configuration file.
