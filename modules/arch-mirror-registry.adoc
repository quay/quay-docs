...
[role="_abstract"]
The mirror registry for {ocp} is a small-scale {productname} deployment for disconnected cluster installation. You can use it to mirror {ocp} release images before deploying a production-grade registry.
