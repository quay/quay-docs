...
[id="listrepoteampermissions-get"]
...
[id="listrepoteampermissions-path-parameters"]
== Path parameters
...
[id="listrepoteampermissions-responses"]
== Responses
...
[id="listrepoteampermissions-example-command"]
== Example command
[source,terminal]
----
$ curl -X GET \
