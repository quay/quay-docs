...
[role="_abstract"]
To automate container image builds from your Git repositories, you can create a custom Git build trigger in {productname}. Build triggers automatically build and push images when you push code to your Git repository.
