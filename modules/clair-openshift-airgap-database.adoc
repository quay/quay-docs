...
[role="_abstract"]
To access the Clair database in a disconnected {ocp} cluster, you can identify the database service, forward its port, and point your Clair configuration at localhost.
