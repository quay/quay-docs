...
[id="listrepositoryimmutabilitypolicies"]
= listRepositoryImmutabilityPolicies

[role="_abstract"]
List Repository Immutability Policies.

[id="listrepositoryimmutabilitypolicies-get"]
...
[id="listrepositoryimmutabilitypolicies-responses"]
== Responses
...
[id="listrepositoryimmutabilitypolicies-example-command"]
== Example command
