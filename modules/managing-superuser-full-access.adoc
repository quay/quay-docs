...
[role="_abstract"]
Superuser full access in {productname} lets administrators grant superusers read, write, and delete rights in organizations that they do not own. You enable the feature with the `FEATURE_SUPERUSERS_FULL_ACCESS` configuration field.
