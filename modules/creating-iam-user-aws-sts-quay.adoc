...
[role="_abstract"]
To configure AWS STS authentication for your {productname} deployment, you can create an IAM user in the AWS console, copy the user ARN, and create access keys. This procedure sets up the IAM user that {productname} uses to authenticate with Amazon S3 using temporary credentials. 
