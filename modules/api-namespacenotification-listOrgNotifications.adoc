...
[id="listorgnotifications"]
= listOrgNotifications

[role="_abstract"]
List Org Notifications.

[id="listorgnotifications-get"]
...
[id="listorgnotifications-path-parameters"]
== Path parameters
...
[id="listorgnotifications-responses"]
== Responses
...
[id="listorgnotifications-example-command"]
== Example command
...
[id="listorgnotifications-example-output"]
== Example output
