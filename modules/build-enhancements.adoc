...
[role="_abstract"]
To build container images in virtualized environments with {productname} on {productname-ocp}, you can use virtual builds. Virtual builds run in unprivileged containers and provide isolation for your build processes.
