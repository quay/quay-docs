...
[role="_abstract"]
Virtual builds in {productname} run build workers in unprivileged containers on {productname-ocp}. This approach provides process isolation without requiring dedicated virtual machines for each build.
