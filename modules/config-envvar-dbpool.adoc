...
[role="_abstract"]
Use the `DB_CONNECTION_POOLING` environment variable and `DB_CONNECTION_ARGS` settings to control whether {productname} pools database connections and the maximum pool size per process.
