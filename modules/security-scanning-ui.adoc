...
[role="_abstract"]
To review the results of a Clair security scan, you can open the *Security Scanner* page for a tag in the {productname} UI. You can inspect detected CVEs and check available remediation options.

.Prerequisites

* For standalone {productname} deployments, you have deployed Clair. For more information, see "Setting up Clair on standalone {productname} deployments"
