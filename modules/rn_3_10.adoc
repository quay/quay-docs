...
{productname} release 3.10.16 is now available with Clair {clairproductminv}. The bug fixes that are included in the update are listed in the link:https://access.redhat.com/errata/RHSA-2025:23064[RHSA-2025:23064] advisory.
