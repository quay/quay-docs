...
[id="updateuserautoprunepolicy-path-parameters"]
== Path parameters
...
[id="updateuserautoprunepolicy-request-body-schema"]
...
[id="updateuserautoprunepolicy-responses"]
== Responses
...
[id="updateuserautoprunepolicy-example-command"]
== Example command
