...
[role="_abstract"]
To remove a geo-replicated site from a standalone {productname} deployment, you can sync blobs between sites, update `config.yaml`, and run the `removelocation` utility.
