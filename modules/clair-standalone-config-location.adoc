...
[role="_abstract"]
To deploy a self-managed Clair container for disconnected {ocp} clusters, you can create a configuration directory, set `disable_updaters` and `airgap` in the Clair configuration file, and start the container with Podman.
