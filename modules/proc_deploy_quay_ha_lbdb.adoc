...
* Quay (ports 80 and 443 on B systems) (For {productname} V3, by default ports 8080 and 8443 are used by the
quay container, but we recommend mapping them to host ports 80 and 443, respectively.)
