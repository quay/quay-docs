...
[role="_abstract"]
Activity logs in {productname} record repository and namespace events for operations and security review. You can view usage patterns and export logs for longer-term retention.
