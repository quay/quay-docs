...
With this release, network policies are applied during installation of upgrade of the {productname} Operator, {cso}, and {qbo}. Because network policies are now automatically applied, security has been enhanced to these operators by restricting communication to necessary channels for these Operators.