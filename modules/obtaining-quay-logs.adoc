...
[role="_abstract"]
To troubleshoot, monitor, and secure your {productname} deployment, you can use log information from containers and pods. Logs support debugging, performance monitoring, security analysis, capacity planning, and deployment verification.
