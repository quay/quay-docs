...
[role="_abstract"]
To create a repository in {productname}, you can push an image with Podman. The push creates the repository if it does not already exist.
...
This applies regardless of the plan you have. 
