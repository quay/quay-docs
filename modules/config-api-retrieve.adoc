...
[id="config-api-retrieve"]

= Retrieving the current configuration

[role="_abstract"]
{productname} provides retrieving the current configuration for registry administrators. You can use this information when you manage your deployment.
