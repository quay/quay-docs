...
[id="updateservicekey-path-parameters"]
== Path parameters
...
[id="updateservicekey-request-body-schema"]
...
[id="updateservicekey-example-command"]
== Example command
