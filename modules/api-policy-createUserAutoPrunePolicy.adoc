...
[id="createuserautoprunepolicy-request-body-schema"]
...
[id="createuserautoprunepolicy-responses"]
== Responses
...
[id="createuserautoprunepolicy-example-command"]
== Example command
