:productname: Red{nbsp}Hat Quay
:productname-ocp: Red{nbsp}Hat Quay on OpenShift Container Platform
:quayio: Quay.io
:productshortname: Quay
:imagesdir: ../images
:ocp: OpenShift Container Platform
:odf: Red{nbsp}Hat OpenShift Data Foundation
:qbo: Quay Bridge Operator
:rhel: Red{nbsp}Hat Enterprise Linux (RHEL)
:rhel-short: RHEL
:ocp-y: 4.18
