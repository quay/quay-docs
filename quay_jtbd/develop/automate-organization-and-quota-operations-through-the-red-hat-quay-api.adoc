...
[role="_abstract"]
Automate organization management, quota limits, mirroring, and global messages by using Red Hat Quay API examples.
...
include::modules/quota-limit-api.adoc[leveloffset=+2]

include::modules/quota-limit-user-api.adoc[leveloffset=+2]

include::modules/organization-management-api.adoc[leveloffset=+1]

include::modules/org-contact-email-api.adoc[leveloffset=+2]
