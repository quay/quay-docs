...
[role="_abstract"]
Create, reassign, revoke, and rotate OAuth 2 access tokens, including OCI referrers tokens, for API authentication.

include::modules/token-overview.adoc[leveloffset=+1]

include::modules/oauth2-access-tokens.adoc[leveloffset=+2]
