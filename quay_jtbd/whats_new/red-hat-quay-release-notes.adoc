...
[role="_abstract"]
When a new Quay release ships, I want to learn what changed—features, fixes, and deprecations—so that I can decide what to adopt or avoid in my environment.
