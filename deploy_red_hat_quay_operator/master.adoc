...
* link:https://docs.redhat.com/en/documentation/red_hat_quay/3/html-single/red_hat_quay_operator_features/index#operator-managed-postgres-tls[TLS encryption for Operator-managed PostgreSQL]
