...
[role="_abstract"] 
To configure {productname} for on-premises and Operator-based deployments, you can use this guide. You can modify your configuration and review required and optional registry settings, environment variables, and Clair scanner options.
...
* link:https://www.redhat.com/en/topics/automation/what-is-yaml[What is YAML?]
...
[id="additional-resources_quayregistry-cr"]
[role="_additional-resources"]
== Additional resources

* link:https://docs.redhat.com/en/documentation/red_hat_quay/{producty}/html-single/securing_red_hat_quay/index#operator-external-tls-secret-reference[Referencing an external TLS Secret for {productname-ocp}]
...
include::modules/config-fields-immutable-tags.adoc[leveloffset=+3]
