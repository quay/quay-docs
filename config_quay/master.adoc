...
include::modules/config-updates-314.adoc[leveloffset=+1]
//required
...
include::modules/splunk-configuration-fields.adoc[leveloffset=+3]
...
//legacy
//include::modules/config-fields-legacy.adoc[leveloffset=+3]
//include::modules/config-fields-v2-ui.adoc[leveloffset=+3]
...
//include::modules/config-fields-misc.adoc[leveloffset=+3]
