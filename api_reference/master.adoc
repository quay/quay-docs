...
[role="_abstract"]
You can use the {productname} REST API, which is based on the OAuth 2.0 protocol, to manage repositories, images, permissions, and other registry resources. This reference documents endpoints, request and response schemas, authentication requirements, and error codes.
...
include::modules/api-org_mirror-createOrgMirrorConfig.adoc[leveloffset=+2]
...
include::modules/api-capabilities-getRegistryCapabilities.adoc[leveloffset=+2]
...
include::modules/api-immutability_policy-createOrgImmutabilityPolicy.adoc[leveloffset=+2]
...
[id="additional-resources_use-api"]
[role="_additional-resources"]
== Additional resources

* link:https://oauth.net/2/[OAuth 2.0 protocol]
* link:https://docs.redhat.com/en/documentation/red_hat_quay/{producty}/html/red_hat_quay_api_guide/index[{productname} API guide]