...
include::modules/rn-3-16-6.adoc[leveloffset=+2]
...
include::modules/rn-3-16-1.adoc[leveloffset=+2]
include::modules/rn-3-16-0.adoc[leveloffset=+2]
include::modules/documentation-changes-316.adoc[leveloffset=+3]
include::modules/new-features-and-enhancements-316.adoc[leveloffset=+3]
include::modules/new-features-and-enhancements-quay-ocp-316.adoc[leveloffset=+3]
include::modules/new-quay-config-fields-316.adoc[leveloffset=+3]
include::modules/new-api-endpoints-316.adoc[leveloffset=+3]
include::modules/notable-technical-changes-316.adoc[leveloffset=+3]
include::modules/deprecations-316.adoc[leveloffset=+3]
include::modules/known-issues-and-limitations-316.adoc[leveloffset=+3]
include::modules/bug-fixes-316.adoc[leveloffset=+3]
