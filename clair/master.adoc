...
* link:https://docs.redhat.com/en/documentation/red_hat_quay/3/html-single/clair/index#clair-ephemeral-storage-overrides[Configuring ephemeral storage for managed Clair]
...
* link:https://docs.redhat.com/en/documentation/red_hat_quay/3/html-single/red_hat_quay_operator_features/index#operator-volume-size-overrides[Volume size overrides]
...
* link:https://access.redhat.com/documentation/en-us/red_hat_quay/3/html/deploy_red_hat_quay_on_openshift_with_the_quay_operator/quay_operator_features#clair-openshift-config[Clair on OpenShift config]
