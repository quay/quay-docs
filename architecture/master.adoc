...
[role="_abstract"]
To plan and deploy {productname} with high availability, you can use this guide for architectural patterns, prerequisites, sizing, and deployment options on-prem or in the cloud. The guide covers infrastructure, content distribution, security, and public cloud deployments.
